                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="date"
                        value={isEditing ? tempUserData.dateOfBirth : userData.dateOfBirth}
                        onChange={(e) => setTempUserData({ ...tempUserData, dateOfBirth: e.target.value })}
                        disabled={!isEditing}
                        className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-blue-600 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={isEditing ? tempUserData.specialization : userData.specialization}
                      onChange={(e) => setTempUserData({ ...tempUserData, specialization: e.target.value })}
                      disabled={!isEditing}
                      className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-blue-600 disabled:bg-gray-100 disabled:cursor-not-allowed"
                    />
                  </div>
            ...
            {activeTab === 'orders' && (
              <div className="space-y-4">
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <div key={order.id} className="border-2 border-gray-200 rounded-xl p-4 hover:border-blue-600 transition-all">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-700">{order.items} item{order.items > 1 ? 's' : ''}</p>
                      ...
                      >
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="font-semibold text-gray-800 mt-1">{address.name}</p>
                            ...
                            <div className="flex gap-2 mt-4">
                              ...
                              {!address.isDefault && (
                                <button className="text-green-600 text-sm font-semibold hover:underline">Set as Default</button>
                              )}
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="flex-1">
                            ...
                            {method.type === 'Credit Card' ? (
                              <>
                                ...
                                <p className="text-gray-600 text-sm">{method.brand} - Expires {method.expiry}</p>
                              </>
                            ) : (
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {wishlistItems.map((item) => (
                      <div key={item.id} className="border-2 border-gray-200 rounded-xl p-4 hover:border-blue-600 transition-all">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="border-b border-gray-200 pb-6 mb-6">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        { id: 'sms', label: 'SMS Notifications', desc: 'Receive order updates via SMS' },
                        { id: 'promo', label: 'Promotional Emails', desc: 'Receive promotional offers and deals' },
                        { id: 'newsletter', label: 'Newsletter', desc: 'Stay updated with latest products' }
                      ].map((pref) => (
                        <label key={pref.id} className="flex items-center justify-between p-4 border-2 border-gray-200 rounded-xl hover:border-blue-600 cursor-pointer transition-all">
                          <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="border-2 border-red-300 rounded-xl p-4 bg-red-50">
                      <p className="text-gray-700 mb-3">Once you delete your account, there is no going back. Please be certain.</p>
                      <button
