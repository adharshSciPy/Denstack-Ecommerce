      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <button onClick={onBackToCart} className="text-gray-500 hover:text-blue-600">Cart</button>
            <ChevronRight className="w-4 h-4 text-gray-400" />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all ${
                      paymentMethod === 'card' ? 'border-blue-600 bg-blue-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all ${
                      paymentMethod === 'upi' ? 'border-blue-600 bg-blue-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all ${
                      paymentMethod === 'netbanking' ? 'border-blue-600 bg-blue-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all ${
                      paymentMethod === 'cod' ? 'border-blue-600 bg-blue-50' : 'border-gray-300 hover:border-blue-400'
                    }`}
                  >
